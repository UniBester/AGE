...
class TestOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--checkpoint_path', default='/data/dgq/fpsp/flower/log_w0-2,3-5_0.0005or_wosigmoid_0.005l1_0dw_unlinear_multi_dense1001/checkpoints/iteration_35000.pt', type=str, help='Path to AGE model checkpoint')
		self.parser.add_argument('--n_distribution_path', type=str, default='data1/', help='Path to distribution of n')
		...
		self.parser.add_argument('--output_path', type=str, default='data1/output', help='Path to save outputs')
		...
		self.parser.add_argument('--beta', default=0.005, type=float, help='Direction selection threshold in A')
